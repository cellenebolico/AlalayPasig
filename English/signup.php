...
<body>
 ...
 <form action="signup.php" method="POST">  
    <div class="form">
        ...
        <div class="form-group">
            <label for="verifyemail"><b>Verify Email</b></label>
            <input type="email" placeholder="Enter Email Again" name="verifyemail" required>
        </div>
    ...
    <div class="agree">
        ...
        <label for="agree">I've read and accept the 
            <a href="../English/navbar/Terms of Services-notlogin.html">Terms of Service</a> and 
