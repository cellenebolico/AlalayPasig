...
<h3>Login to AlalayPasig</h3>
<h4>New to AlalayPasig? <a href="signup.php" class="sign">Signup now</a></h4>
...
<form action="login.php" method="POST">
    ...
    <label for="email"><b>Email</b></label>
        ...
        <p>Don't have an account yet? <a href="signup.php" class="sign2">Signup</a></p>

        <div class="links">
        <a href="">Help</a>
        <a href="../English/navbar/contacts-notlogin.html">Contact</a>
        <a href="../English/navbar/Terms of Services-notlogin.html">Terms of Service</a>
        <a href="../English/navbar/Privacy and Policy-notlogin.html">Privacy Notice</a>
        <a href="" class="reserved">©2025 AlalayPasig. All right reserved</a>
        </div>      
